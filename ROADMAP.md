...
**当前阶段**：阶段 2a ✅ / **下一步 = Mode 4 v0.2c 本地图片** / 阶段 4 v0.3-v0.5 待续 / 阶段 5 Mode 2 app 未启动
**已完成节点**（本轮 session）：
  ...
  - ✅ Mode 01 1C/1A skill 化（待 commit）— `skill/modes/01-richtext/` 落地，transform.mjs body 与 web 版 0 diff，bench 1C plan demo `directivesApplied: 9 / directivesMissed: 0`
**仍待**（按**实际执行顺序**，已重排）：
  - **v0.2c — Mode 4 本地/base64 图片走 `+media-insert`（next，下一个 PDCA）**
