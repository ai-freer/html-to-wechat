...
**当前阶段**：阶段 2a ✅ / Mode 4 v0.2c ✅ / Mode 4 v0.3 ✅ / **下一步 = Mode 4 v0.4 局部精修工程化** / 阶段 4 v0.5 待续 / 阶段 5 Mode 2 app 未启动
**已完成节点**（本轮 session）：
  ...
  - ✅ Mode 4 v0.3（待 commit）— 6 个探针文档 + 3 项 finding 固化 docs/04 §7：ol>callout 服务端吞 + callout 内多 span 粘连用 joinWith 修 + v0.1 Mermaid 内联 DSL 已足够稳
**仍待**（按**实际执行顺序**，已重排）：
  - **v0.4 — Mode 4 局部精修工程化（`docs +update` 8 种指令的 helper）（next，下一个 PDCA）**
